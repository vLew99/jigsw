...
function block_click(i, e) {
	if(board.array[i].selected == false) {
		...
		// let middleY = block1_selected.image_loc[1] - (board.array[i].img.height/2);
		// let middleX = block1_selected.image_loc[0] - (board.array[i].img.width/2);
		// block1_selected.img.style.top = middleY.toString() + "px";
		// block1_selected.img.style.left = middleX.toString() + "px";
		// block1_selected.image_loc[1] = e.clientY;
		// block1_selected.image_loc[0] = e.clientX;
		// board.array[i].img.style.position = "static";
		// swap_blocks(block1_selected, board.array[i]);
